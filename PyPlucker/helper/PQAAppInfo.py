...
def is_valid_tbmp(data, default):
    if len(data) < 16:
        return 0
    #
    # Current palms can use bitmaps of format > 1.  They can even take TAIB
    # bitmat resource families with multiple color bitmaps, etc... so most
    # of these assumptions are now invalid.  See
    # http://www.palmos.com/dev/support/docs/palmos/PalmOSReference/Bitmap.html
    #
    # If you do have a sample bitmap of the type you want, then you can
    # reinstate a similar test -- though I suspect they wanted 10:16 on the
    # second row, instead of the (trivially true) 10:6.
    #
